...
**User list** is a table describing your existing users, including their ID, system login, balance, and the number of devices on their account. Each user created using the <img src="../../.gitbook/assets/image (76).png" alt="" data-size="line"> button is displayed here.
...
CSV and XLSX formats allow importing files into CRMs or mailing providers without any additional editing. To download the user data, click <img src="../../.gitbook/assets/image (18).png" alt="Download user data" data-size="line"> and select the file format. The download starts automatically, and you can use the exported data as you see fit.
