---
description: >-
  Create individual user accounts in Admin Panel or bulk-import multiple users
  at once from an XLSX or CSV file using the provided template
---

# Creating users

To add a new user to the Admin panel, click <img src="../../.gitbook/assets/image (78).png" alt="" data-size="line"> on the Users page. This opens the **New user** window:
