...
When this parameter name is displayed, the statuses are shown as \[1RNS]. This type is used if the device protocol doesn't permit sending the status of all I/Os at once with a single value.
