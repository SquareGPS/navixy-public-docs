...
You can personalize your service by choosing one of preconfigured color themes for web UI and mobile apps. Use this feature to design a unique look and feel that reflects your corporate brand and enhances your company's identity. The process is simple and straightforward, allowing you to create a customized experience.

### How to select a color scheme

You can choose a color scheme from a list of available themes in the **UI themes → Web interface** section. When you select a theme, you see screenshots of the chosen color palette. Once you've decided on a theme, click **Save** to apply the changes.
