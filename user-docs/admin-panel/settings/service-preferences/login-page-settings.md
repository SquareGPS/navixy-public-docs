...
If this option is enabled, users can create new accounts from both the UI and mobile apps. A registration button appears on the UI. If this option is disabled, user creation is possible through Admin Panel or the Admin Panel API.
