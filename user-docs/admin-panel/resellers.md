...
Navixy's channel partners have the ability to expand their business by creating a network of sub-dealers or resellers. This section describes how to create a reseller and the various options of configuring them.
...
Resellers aren't allowed:

* Modify the GIS package. The GIS package is inherited from the partner's account.
* Create their own resellers. To do this, they need to become a partner.
...
In case of a violation of the cooperation conditions, the partner can restrict the reseller's access to their Admin Panel. However, the reseller's user interface isn't suspended.
