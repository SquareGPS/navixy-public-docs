...
<figure><img src="../.gitbook/assets/image (1).png" alt="Report page"><figcaption><p>Report page</p></figcaption></figure>
...
4. To learn more about the owner of any device active during the period, click their user name. This opens the **User** window, which provides the same information and options as the right side panel of the [Users](users/) page.
