---
description: >-
  Create fuel sensor entries in Navixy and configure calibration settings,
  filtering options, and measurement parameters for accurate readings.
---
...
* **Ignore in movement**: the platform will automatically exclude any drains and refills that occur during movement from rules and reports. Movement is determined by the [Parking Detection setting](/broken/spaces/446mKak1zDrGv70ahuYZ/pages/kuQsXSvRlmWewB0IVXgM).
...
To upload the calibration table file, click <img src="../../../../.gitbook/assets/image (2) (4).png" alt="" data-size="line">. Calibration files can be generated by Omnicomm LLS Monitor utility. Only XML file format is supported.

![](../../../../.gitbook/assets/upload_calibration_table_en.png)

For more precise setting, click "Advanced settings" button <img src="../../../../.gitbook/assets/image (3) (4).png" alt="" data-size="line">. These settings are Ignore values and Multiplier.
