---
description: >-
  Customize your Navixy account preferences: set language, time zone,
  measurement system, date format, and manage local file storage settings.
---
...
{% hint style="info" %}
The measurement system you choose enforces that system on the Navixy platform. For example, if your choice is set to imperial and you have a sensor sending data in Celsius, the Navixy platform automatically converts that to Fahrenheit.
{% endhint %}
