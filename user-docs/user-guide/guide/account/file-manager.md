...
{% hint style="info" %}
Not all feature usage requires file uploads. For example, you can create a service work without attaching any files. In that case, no files are added to File Manager.
{% endhint %}
