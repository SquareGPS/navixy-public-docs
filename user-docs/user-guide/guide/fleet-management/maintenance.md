...
4. **Save the task:**\
   Save the service task, and the Navixy platform sends notifications based on your settings.
...
If a task is no longer needed, delete it from the Maintenance section. Remember, deleted tasks can't be recovered.
